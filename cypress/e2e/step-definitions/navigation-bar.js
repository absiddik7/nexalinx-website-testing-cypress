...
it('Clicking on Services from navigation bar opens dropdown menu', () => {
    ...
    Then('the dropdown menu for Services should open with the following {string}', (options) => {
...
it('Clicking on Technologies from navigation bar opens dropdown menu', () => {
    ...
    Then('the dropdown menu for Technologies should open with the following {string}', (options) => {
        cy.contains('a', options).should('be.visible');
    });
})
...
it('Clicking on About US from navigation bar opens dropdown menu', () => {
    ...
    Then('the dropdown menu for About US should open with the following {string}', (options) => {
        cy.contains('a', options).should('be.visible');
    });
})
